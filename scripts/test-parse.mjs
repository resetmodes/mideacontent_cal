...
/* ── 상대 주차 ('26.7) — TODAY=2026-07-07(화), 주 시작 월요일: 이번주 = 7/6(월)~12(일) ── */
t('다음주 목요일 앱푸쉬 발송', { date: '2026-07-16', channel: '백화점APP', title: 'APP푸쉬 발송' })
t('다다음주 월요일 여름 세일 카톡', { date: '2026-07-20', channel: '카카오톡' })
t('지난주 토요일 리뷰 정리', { date: '2026-07-04' })
t('이번주 금요일 인스타 릴스', { date: '2026-07-10', channel: '인스타' })
t('다음 주 일요일 점검', { date: '2026-07-19' }, '띄어쓰기 변형')
t('차주 화요일 보고', { date: '2026-07-14' }, '차주 = 다음주')
t('저번주 수요일 발행 건', { date: '2026-07-01' }, '저번주 = 지난주')
t('7/10 다음주 언급만', { date: '2026-07-10', title: '다음주 언급만' }, '명시 날짜가 상대 주차보다 우선')
t('다음주 월~수 여름 프로모션 카톡', { date: '2026-07-13', endDate: '2026-07-15', channel: '카카오톡' }, '상대 주차 기간')
t('다음주 월요일~수요일 점검', { date: '2026-07-13', endDate: '2026-07-15' }, '기간 풀 표기')
t('이번주 목~금 정리', { date: '2026-07-09', endDate: '2026-07-10' })
t('지난주 금~일 팝업 운영', { date: '2026-07-03', endDate: '2026-07-05' })
t('다음주 금~월 연휴 프로모션', { date: '2026-07-17', endDate: '2026-07-20' }, '주 넘는 범위 = 다음 주로 이월')
t('다음주 금 앱푸쉬 발송', { date: '2026-07-17', channel: '백화점APP' }, '요일 축약 단일')
t('차주 화 보고 정리', { date: '2026-07-14' }, '축약 + 동의어')
t('다음주 월간 보고 검토', { date: null }, "'월간'의 월은 요일 아님 — 미인식")
t('다음주 토스 배너 검토', { date: null }, "'토스'의 토는 요일 아님 — 미인식")
...
/* ── '26.7 세부 추가: K-Ride(타겟APP) · 네이버/토스/카카오(기타) ── */
t('7/30 K-Ride 여름 프로모션', { channel: '타겟APP', sub: 'K-Ride' })
t('7/30 케이라이드 배너', { channel: '타겟APP', sub: 'K-Ride' })
t('8/2 네이버 브랜드검색 집행', { channel: '기타', sub: '네이버' })
t('8/2 토스 배너 집행', { channel: '기타', sub: '토스' })
t('8/3 카카오 모먼트 비즈보드', { channel: '기타', sub: '카카오' }, "'카카오'만은 기타 — 골프·카톡은 기존 유지")
t('8/3 카카오골프 메인탑', { channel: '타겟APP', sub: '카카오골프' }, '구체 지칭 우선 불변')
t('8/3 카카오톡 친구톡 발송', { channel: '카카오톡', sub: '친구톡' }, '카톡 계열 불변')

/* ── '26.8 H.Point 한 줄 등록 자동 인식(에포·에이치포인트) ── */
t('8/4 에포 리사이클 캠페인', { channel: 'H.Point', title: '리사이클 캠페인' }, "'에포' 축약 인식 + 제목 정리")
t('8/4 에이치포인트 리사이클 캠페인', { channel: 'H.Point', title: '리사이클 캠페인' }, "'에이치포인트' 인식 + 제목 정리")
t('8/4 h포인트 배너 교체', { channel: 'H.Point', title: '배너 교체' })
t('8/4 hpoint 배너 교체', { channel: 'H.Point', title: '배너 교체' })
...
t('7.15 촬영 7.25 현장 스케치 인스타',
  { shootDate: '2026-07-15', date: '2026-07-25', title: '현장 스케치' },
  "'26.7 버그: 업로드 라벨 없는 두 번째 날짜가 제목에 남던 문제")
t('7/15 촬영 다음주 화요일 업로드분 유튜브',
  { shootDate: '2026-07-15', date: '2026-07-14' }, '촬영 라벨 + 상대 날짜 업로드')
...
tm('8/1 임원 보고 자료 마감', { date: '2026-08-01', channel: '업무', title: '임원 보고 자료 마감' }, '업무 유형 ("마감")')
tm('7/24 전사 회의', { channel: '업무', title: '전사 회의' }, '업무 유형 ("회의")')
tm('8/1~3 김상수 부산 출장 보고 준비', { channel: '출장' }, '근태 키워드가 업무보다 우선')
