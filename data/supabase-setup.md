...
타 팀이 매체 광고, 바이럴을 신청하는 창구입니다. 1차는 어드민 게이트 뒤 비공개로 운영합니다.
...
- 신청(INSERT)은 **anon도 허용** — 2차에 미러(무로그인)에서 폼을 공개하기 위한 설계입니다.
  쓰기 전용이라 신청자는 남의 신청을 볼 수 없습니다 (SELECT anon 정책 없음)
- 열람은 로그인 계정 전체, 배정과 상태 변경은 `team_writers`만
